...
def process_show_inventory(report, show_inventory):
    ...
    if "success" in show_inventory["status"]:
        ...
        for row in module_rows:
           ...
           data['tx_pwr (dBM)'] = getnodevalue(row,'./TABLE_lane/ROW_lane/tx_pwr') #line for txpwr, rxpwr measurement. new lines added.
           data['rx_pwr (dBM)'] = getnodevalue(row,'./TABLE_lane/ROW_lane/rx_pwr')
           data['tx_pwr Warning High (dBM)'] = getnodevalue(row,'./TABLE_lane/ROW_lane/tx_pwr_warn_hi')
           data['tx_pwr Warning Low (dBM)'] = getnodevalue(row,'./TABLE_lane/ROW_lane/tx_pwr_warn_lo')
           data['rx_pwr Warning High (dBM)'] = getnodevalue(row,'./TABLE_lane/ROW_lane/rx_pwr_warn_hi')
           data['rx_pwr Warning Low (dBM)'] = getnodevalue(row,'./TABLE_lane/ROW_lane/rx_pwr_warn_lo')
